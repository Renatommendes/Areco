...
begin
    try
        try
            ...
            FConn.Params.Values['DriverID'] := ini.ReadString('Banco de Dados', 'PG', '');
            FConn.Params.Values['Database'] := ini.ReadString('Banco de Dados', 'produtos', '');
            FConn.Params.Values['User_name'] := ini.ReadString('Banco de Dados', 'postgres', '');
            FConn.Params.Values['Password'] := ini.ReadString('Banco de Dados', '12345678', '');
            FConn.Params.Add('Port=' + ini.ReadString('Banco de Dados', 'Port', '5433'));
